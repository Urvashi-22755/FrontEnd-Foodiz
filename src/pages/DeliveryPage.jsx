    ...
    <React.Fragment>
      ...
      <div className={classes.root}>
        <div className={classes.deliveryImageDiv}>
          <img
            src="https://image.freepik.com/free-vector/food-delivery-staff-ride-motorcycles-deliver-food-during-confinement-home-from-corona-virus_68708-821.jpg"
                  ...
                  <Grid item xs={12} sm={6} md={6} lg={12}>
                    <Paper className={classes.paper}>
                      <div className={classes.orderDetails}>
                        ...
                        <div>
                          PickUp Address:{" "}
                          <b>{order.restLocation} Chiloda Gujarat</b>
                        </div>
                        <div>
                          {" "}
                          Drop address: <b>{order.orderLocation}</b>
                        </div>
